...
//
func (r *Raft) RequestVote(args *RequestVoteArgs, reply *RequestVoteReply) { // TODO check for
...
func (r *Raft) sendRequestVoteHandler(index int, newTerm int, acceptedVoteRequestCount *int32) {
...
func (r *Raft) startElections() {
	...
	for i := range r.peers {
		...
		go r.sendRequestVoteHandler(i, newTerm, &acceptedVoteRequestCount)
	}
}
